    ...
    public static List<WorldDefinition> definitions() {
        return List.of(
                ...
                world("quarry", "quarry", "The Quarry",
                        ...
                        WorldType.RESOURCE, "Weekly Reset", WorldStatus.SEASONAL, "Normal", 12_000,
                        PvpMode.DISABLED, true, true, "NEXUS_POINTS", false, true, "ASHFALL_GROUP",
                        new ResetPolicy.Weekly(DayOfWeek.MONDAY, LocalTime.of(4, 0), ZoneOffset.UTC, true), ArchivePolicy.none(), true, true, true,
